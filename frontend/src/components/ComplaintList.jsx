    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-6">
          ...
          {/* ✨ NEW SECTION: Resolution Proof ✨ */}
          {complaint.status === 'resolved' && complaint.proofUrl && (
            <div className="pt-4 border-t border-gray-200">
                <h4 className="font-semibold text-text-on-light mb-2">Resolution Proof</h4>
                <div className="rounded-lg overflow-hidden border border-gray-200">
                    <img src={complaint.proofUrl} alt="Resolution proof" className="w-full h-auto object-cover" />
                </div>
            </div>
          )}
